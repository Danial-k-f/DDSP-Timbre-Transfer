...
class SupervisedAudioData(AudioData):
    def __init__(
        ...
        self.num_frame = int(self.waveform_sec / self.frame_resolution)  # number of csv rows
    ...
    def __getitem__(self, file_idx):
        ...
        # ---- Load full audio & slice manually ----
        audio, sr = torchaudio.load(self.paths[file_idx])
        ...
        audio = audio[0, waveform_from:waveform_to]  # (channel, time) → mono slice
