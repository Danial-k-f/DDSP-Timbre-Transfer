...
# ===================== Imports from ddsp_model ===================== #
from ddsp_model.training import Trainer, MSSLoss, AudioDataset, RAdam, setup, set_seeds
from ddsp_model.model.autoencoder import AutoEncoder
from ddsp_model.training.dataloader import SupervisedAudioData
...
# ---------------- Config ---------------- #
config = setup(default_config="../configs/sax_48k.yaml")   # ← کانفیگ جدید 44.1k
from omegaconf import OmegaConf
